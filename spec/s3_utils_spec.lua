    ...
    context("when ssl certs can be fetched successfully", function()
      before_each(function()
        httpc_stub.request_uri = function(self, uri, opts)
          assert.are.equal(uri, "https://s3-us-west-2.amazonaws.com/rise-development-usw2/certs/foo-bar-express.rise.cloud/ssl.crt?AWSAccessKeyId=AKIAJZHYMGEHIL3THKWA&Expires=1460579519&Signature=J7qxNwJQ3bZmE8dvj9daZalg5Fg=")
